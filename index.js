...
function getReviewByRating(array, usrRating) {
  /* code here */
  let rReviews = []; 
  for(let i = 0; i < array.length; i++) 
  { 
    if(array[i].rating === usrRating) { 
        rReviews.push(array[i].feedback); 
    }
  }
